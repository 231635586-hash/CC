...
/**
 * 工作台 Tab（v0.2.x Plan B 抽出）
 *
 * 内容：4 维统计 + 当前进行中卡 + 最近轨迹
 * 依赖：dispatchList (props) + DISPATCH_STATUS_MAP 常量
 */
...
const emit = defineEmits<{
  ...
  (e: 'switchTab', tab: 'orders' | 'gps'): void
}>()
...
/* StatusTag 复用（StatusTag.vue 已定义 tag-* CSS 类） */
:deep(.status-tag) {
  font-size: var(--font-size-mini);
  padding: 4rpx 12rpx;
